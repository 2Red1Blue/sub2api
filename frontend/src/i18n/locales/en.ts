  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        editAllFiltered: 'Bulk edit all {count} account(s)',
      ...
      accountNameOrImportPrefix: 'Account Name / Batch Import Prefix',
      enterAccountName: 'Enter account name',
      enterAccountNameOrImportPrefix: 'Use an account name for single-account auth; leave empty to use JSON filenames for Codex batch import',
      ...
      oauth: {
        ...
        openai: {
          ...
          codexSessionDesc: 'Choose JSON files or paste Codex JSON / accessToken. Accounts use the step 1 settings.',
          codexSessionInputLabel: 'Codex JSON or accessToken',
          codexSessionChooseFiles: 'Choose JSON Files',
          codexSessionClearFiles: 'Clear Files',
          codexSessionFilesLoaded: '{count} JSON files selected',
          codexSessionFileReadFailed: 'Failed to read JSON files',
          codexSessionEmptyJsonFile: '{name} is empty',
          codexSessionInvalidJsonFile: '{name} is not valid JSON',
    ...
    settings: {
      ...
      scheduling: {
        ...
        gatewayMaxAccountSwitches: 'Max Account Switches',
        gatewayMaxAccountSwitchesHint: 'Maximum account switches for one request after upstream errors. Default is 10 and changes apply to new requests immediately.',
      },
      gatewayForwarding: {
