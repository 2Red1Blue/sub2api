  ...
  admin: {
    ...
    accounts: {
      ...
      bulkActions: {
        ...
        editAllFiltered: '批量编辑全部 {count} 个账号',
        clear: '清除选择',
        edit: '批量编辑账号',
        delete: '批量删除',
      ...
      platform: '平台',
      accountName: '账号名称',
      accountNameOrImportPrefix: '账号名称 / 批量导入前缀',
      enterAccountName: '请输入账号名称',
      enterAccountNameOrImportPrefix: '单账号填写账号名称；Codex 文件批量导入可留空使用文件名',
      accountType: '账号类型',
      claudeCode: 'Claude Code',
      ...
      oauth: {
        ...
        openai: {
          ...
          codexSessionDesc: '选择 JSON 文件或粘贴 Codex JSON / accessToken，按第一步配置创建账号。',
          codexSessionInputLabel: 'Codex JSON 或 accessToken',
          codexSessionChooseFiles: '选择 JSON 文件',
          codexSessionClearFiles: '清除文件',
          codexSessionFilesLoaded: '已选择 {count} 个 JSON 文件',
          codexSessionFileReadFailed: '读取 JSON 文件失败',
          codexSessionEmptyJsonFile: '{name} 是空文件',
          codexSessionInvalidJsonFile: '{name} 不是有效 JSON',
    ...
    settings: {
      ...
      scheduling: {
        ...
        gatewayMaxAccountSwitches: '最大账号切换次数',
        gatewayMaxAccountSwitchesHint: '单次请求遇到上游错误时最多切换多少个账号。默认 10，保存后立即对新请求生效。',
      },
      gatewayForwarding: {
        title: '请求转发行为',
