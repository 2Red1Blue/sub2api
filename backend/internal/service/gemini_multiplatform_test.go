...
func (m *mockAccountRepoForGemini) CreateBatch(ctx context.Context, accounts []*Account) error {
	return nil
}
...
func (m *mockAccountRepoForGemini) BindGroupsForAccounts(ctx context.Context, accountIDs []int64, groupIDs []int64) error {
	return nil
}
